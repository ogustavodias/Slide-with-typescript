...
export default class Slide {
    ...
    createTimeBar() {
        if (this.timeBarContainer) {
            ...
            this.timeBarItens = [
                ...this.timeBarContainer.querySelectorAll("span > span"),
            ];
        }
    }
    addControls() {
    ...
    updateCurrent() {
        ...
        if (this.timeBarContainer) {
            ...
            this.timeBarItens[this.currentIndex].style.animationDuration = `${this.time}ms`;
        }
    }
    auto() {
        if (this.currentElement instanceof HTMLVideoElement) {
            ...
            this.timeBarItens[this.currentIndex].style.animationDuration = `${time}ms`;
        }
        else
